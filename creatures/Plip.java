...
public class Plip extends Creature {
    ...
    public Plip replicate() {
        Plip plipClone = new Plip(this.energy / 2);
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        boolean anyClorus = !ClorusNeighbors.isEmpty();

        /** if none of the neighbors are empty, return "stay" */
...
//            Direction d = emptyNeighbors.getFirst();
